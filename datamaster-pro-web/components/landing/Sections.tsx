        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-10">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative bg-surface-50 rounded-3xl p-8 border border-surface-100 hover:border-primary-100 hover:shadow-xl hover:shadow-primary-500/5 transition-all duration-300"
            >
              ...
              <p className="text-surface-700 mb-6 leading-relaxed">"{testimonial.comment}"</p>
              <div className="flex items-center gap-4 pt-4 border-t border-surface-200">
                ...
                <div>
                  <div className="font-bold text-surface-900 text-sm">{testimonial.name}</div>
                  <div className="text-surface-500 text-xs">{testimonial.role} @ {testimonial.company}</div>
                </div>
              </div>
            </motion.div>
          ))}
